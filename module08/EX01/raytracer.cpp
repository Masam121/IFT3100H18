// IFT3100H18_Raytracer\raytracer.cpp
...
// déclaration d'un graphe de scène
std::vector<Sphere> scene;

Vector camera_orientation(Vector(0, -0.042612, -1).normalize());

constexpr Vector camera_position(50, 52, 295.6);
...
// générateur de nombres pseudo-aléatoires (mersenne twister)
std::mt19937 rng{rd()};
...
// fonction appelée quand le rendu de la scène est terminé
void terminate()
{
