// IFT3100H18_Locator/renderer.cpp
...
void Renderer::setup()
{
  ...
  // allocation d'un espace mémoire suffisament grand pour contenir les données de l'ensemble des localisateurs
...
void Renderer::reset()
{
  ...
  dispatch_locators(locator_count, std::min(framebuffer_width, framebuffer_height));
