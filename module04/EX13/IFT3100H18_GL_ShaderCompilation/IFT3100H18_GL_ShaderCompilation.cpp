// IFT3100H18_GL_ShaderCompilation.cpp
// Exemple de compilation d'un shader avec OpenGL.

// entrée
// • Code source d'un shader sous forme de deux chaines de caractères (shader de sommets et shader de fragments).
// sortie
...
// création d'un nouveau shader de sommets
...
// extraction du status d'assemblage
...
// commande de dessin qui utilise le shader
glDrawArrays(GL_TRIANGLES, 0, vertex_count);


// 6. destruction d'un shader
