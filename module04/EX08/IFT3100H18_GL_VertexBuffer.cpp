// IFT3100H18_VertexBufferCreate.cpp
...
VertexStructureure* vertex_array;

// allocation d'un espace mémoire suffisament grand pour contenir les données des attributs de tous les sommets
vertex_array = (VertexStructureure*) std::malloc(vertex_buffer_size * vertex_structure_size);
...
glBufferSubData(GL_ARRAY_BUFFER, vertex_offset * sizeof(VertexStructure), updated_vertex_count * sizeof(VertexStructure), vertex_array);
