// IFT3100H18_TriangleSoup/renderer.cpp
...
void Renderer::reset()
{
  ...
  soup_radius = std::min(framebuffer_width * 0.45f, framebuffer_height * 0.45f);
...
void Renderer::draw_soup()
{
  ...
  ofRotate(offset_y, 0.0f, 1.0f, 0.0f);

  // légère rotation en Z de la soupe
  ofRotate(ofGetFrameNum() * 0.1f, 0.0f, 0.0f, 1.0f);
